...
pc_agent = [
    ...
    "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:69.0) Gecko/20100101 Firefox/79.0",
    ...
    #"User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/82.0.3538.102 Safari/537.36 Edge/18.18362",
    ...
    "Mozilla/5.0 (Android 7.1.1; Mobile; rv:68.0) Gecko/76.0 Firefox/79.0",
...
def random_ua():
    return random.choices(pc_agent)[0]

if __name__ == "__main__":
    url = 'https://www.qiushibaike.com/text/'
    h = get_headers(url=url)
    print(h)
# h = get_headers('https://www.a.com/rr/cc')
# h['range']='kk'
# print(h)
